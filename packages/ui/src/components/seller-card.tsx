  ...
  return (
    <div className={cn('rounded-xl border border-gray-100 bg-white p-4', className)}>
      <div className="flex items-start gap-3">
        <div className="relative h-12 w-12 rounded-full bg-brand-50 flex items-center justify-center text-brand-600 font-semibold text-lg">
          {name.charAt(0)}
          {isVerified && (
            <div className="absolute -bottom-0.5 -end-0.5 w-5 h-5 rounded-full bg-white flex items-center justify-center">
